...
const services = [
    {
        ...
        description: 'نبتكر مشاريع عمرانية متكاملة تتبنى أعلى معايير الجودة والاستدامة، مع التركيز على التصاميم الحديثة التي تلبي تطلعات عملائنا.'
    },
    {
        icon: <FiTrendingUp />,
    ...
    },
    {
        ...
        description: 'نقدم دراسة و حلول تشغيلية احترافية تضمن استمرارية المشاريع وحفظ قيمتها السوقية، من خلال أنظمة متطورة للصيانة والإدارة المتكاملة .'
    },
    {
        icon: <FiUserCheck />,
        title: 'الحلول العقارية المتكاملة',
        description: 'نوفر منظومة خدمات شاملة تبدأ من الدراسات إلى التنفيذ، لضمان تجربة قيمة مضافة حقيقية في كل مراحل المشروع العقاري.'
    }
];
