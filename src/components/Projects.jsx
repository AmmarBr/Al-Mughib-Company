  ...
  return (
    <div className='mx-auto py-4 pt-20 px-6 pb-20 md:px-20 lg:px-32 w-full overflow-hidden' id='Projects'>
      <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>
        المشاريع
        <span className='underline underline-offset-4 decoration-1 under font-light'> المنجزة</span>
      </h1>
          ...
          {projectsData.map((project, index) => (
            <div key={index} className='relative flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4'>
              ...
              {/* ختم تم البيع */}
                ...
                <div className="absolute top-3 left-3 bg-red-600 text-white text-sm font-bold px-3 py-1 rounded rotate-12 shadow-lg">
                  تم البيع
                </div>
              ...
              <div className='absolute bottom-5 left-0 right-0 flex justify-center'>
                <div className='inline-block bg-white px-4 py-2 rounded shadow-lg w-3/4 text-center'>
                  ...
                  <p className='text-gray-700 font-bold'>{project.disc}</p>
                </div>
              </div>
            </div>
          ))}
